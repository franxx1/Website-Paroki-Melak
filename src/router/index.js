...
const Berita = () =>
  import("../components/pages/berita-dan-pengumuman/berita.vue");
const BeritaDetail = () =>
  import("../components/pages/berita-dan-pengumuman/berita_detail.vue");

const Pengumuman = () =>
  import("../components/pages/berita-dan-pengumuman/pengumuman.vue");
const PengumumanDetail = () =>
  import("../components/pages/berita-dan-pengumuman/pengumuman_detail.vue");

const Sakramen = () => import("../components/pages/sakramen/sakramen.vue");
const SakramenDetail = () =>
  import("../components/pages/sakramen/sakramen_detail.vue");
