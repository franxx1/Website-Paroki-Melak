...
<template>
  <section
    class="min-h-screen font-sans text-slate-800 flex flex-col overflow-hidden"
    id="pelayanan"
  >
      ...
      <div class="container mx-auto max-w-4xl relative z-10">
        ...
        <div class="flex flex-col items-center mb-16">
          ...
          <h1 class="text-6xl font-serif text-[#5D181E] mb-4 relative">
            Pelayanan
            <span
              class="absolute -bottom-2 left-1/2 -translate-x-1/2 w-24 h-1 bg-[#5D181E] rounded-full"
            ></span>
          </h1>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div class="space-y-6">
            <div class="flex items-center space-x-4 mb-6">
              <div
                class="w-12 h-12 rounded-full bg-[#5D181E] flex items-center justify-center text-[#FFF9E6]"
              >
                <svg
            ...
            >
              <ul class="space-y-4 text-[#5D181E]">
                <li
                  class="flex items-center p-2 hover:bg-white/50 rounded-lg transition-colors"
                >
                  <span class="w-2 h-2 rounded-full bg-[#5D181E] mr-3"></span>
                  <span class="font-medium"
                    >Buka setiap hari kerja (Senin - Sabtu)</span
                  >
                </li>
                <li
                  class="flex items-center p-2 hover:bg-white/50 rounded-lg transition-colors"
          ...
          <div class="space-y-6">
            ...
            <div class="space-y-4">
              <!-- Card Item -->
              <div
                class="bg-white/40 backdrop-blur-md border border-white/50 rounded-xl p-4 flex justify-between items-center cursor-pointer group hover:bg-white/70 hover:scale-105 transition-all duration-300 shadow-md hover:shadow-xl"
              >
                <div>
                  <h3
                    class="text-[#5D181E] font-bold uppercase tracking-wide mb-1 text-lg"
                  >
                    Baptis Bayi
                  </h3>
